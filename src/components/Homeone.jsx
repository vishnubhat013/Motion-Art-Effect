...
<>
    ...
    <div className='pt-12 md:mx-8 mx--'>
      <div className=" md:px-4 px-0 pt-10 flex justify-between">
      <div>
      ...
      <div className="flex mt-8 md:flex-row flex-col  items-center md:items-start w-full">
...
<div className="flex mt-28 text-2xl gap-8 justify-between  items-center md:flex-row flex-col">
    ...
    <div className="md:items-end items-center">
        <img src="/motionarteffect-img5.png " className=""/>
    </div>
</div>
...
<div>
    <div className="md:mt-32 mt-8 flex-col justify-center text-center">
        ...
        <p className="text-[#9890a9] pt-6 flex md:text-lg text-base justify-center items-center ">Whether you're a seasoned web designer or just starting out,Motion Art for</p>
        <p className="text-[#9890a9] pt-1 flex justify-center md:text-lg text-base">Elementor seamlessly integrates with the Elementor platform, providing you </p>
        <p className="text-[#9890a9] pt-1 flex justify-center md:text-lg text-base">with a seamless and intuitive experience.</p>
        ...
        <p className="text-[#eee5ff] text-2xl pt-4 font-semibold">Light Weight</p>
        <p className="text-[#9890a9] pt-6 flex ">Motion Art for Elementor is designed to be lightweight.</p>
        ...
        <div className="px-8 py-4">
        <p className="text-[#eee5ff] text-2xl pt-4 font-semibold">100% Responsive</p>
        <p className="text-[#9890a9] pt-6 flex">Create a constitent visual experience across all devices.</p>
        ...
        <div className="px-8 py-4">
        <p className="text-[#eee5ff] text-2xl pt-4 font-semibold">User Friendly Interface</p>
        <p className="text-[#9890a9] pt-6 flex ">Ensure a smooth experience for both applications and administrators.</p>
